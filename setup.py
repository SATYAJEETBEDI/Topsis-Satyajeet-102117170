...
setup(
  name = 'Topsis-Satyajeet_102117170',         # How you named your package folder (MyLib)
  packages = ['Topsis-Satyajeet'],   # Chose the same as "name"
  version = '1.0.4',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'Contains the Topsis package by satyajeet on topsis',   # Give a short description about your library
